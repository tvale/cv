...
\headedsection
  ...
  \headedsubsection
    ...
    {\bodytext{I work in the context of the \href{https://dev.mysql.com/doc/refman/8.0/en/group-replication.html}{MySQL Group Replication} team. Most of the time I work on the MySQL Group Replication's underlying \href{https://mysqlhighavailability.com/the-king-is-dead-long-live-the-king-our-homegrown-paxos-based-consensus/}{Group Communication System (XCom)}, which provides distributed consensus using the Paxos protocol.}}
}
...
\headedsection
  ...
  \headedsubsection
    ...
    {2012---2019}
    {\bodytext{Dissertation: Executing requests concurrently in state machine replication.}}
}
...
\headedsection  % sets the header for the section and includes any subsections
  {\href{https://github.com/tvale/xkcdesktop}{xkcdesktop}}
  {\href{https://github.com/tvale/xkcdesktop}{github.com/tvale/xkcdesktop}} {%
  \bodytext{
    An application to browse \href{https://xkcd.com}{xkcd} comics on the desktop. Built using \href{https://wiki.gnome.org/Projects/Vala}{Vala} and \href{https://github.com/elementary/granite}{Granite/GTK+}.
  }
}

\headedsection  % sets the header for the section and includes any subsections
  {\href{https://github.com/tvale/libxkcd}{libxkcd}}
  {\href{https://github.com/tvale/libxkcd}{github.com/tvale/libxkcd}} {%
  \bodytext{
    A C library to browse \href{https://xkcd.com}{xkcd} comics.
  }
}
